...
public class GetFlickrJsonData extends GetRawData {
    ...
    //this block below not in TB codeL64
    ...
    //this block above not in TB codeL64
    ...
    public void processResult(){
        ...
        try {
            ...
            for(int i=0; i<itemsArray.length(); i++){
             ...
             //   String link = jsonPhoto.getString(FLICKR_LINK);  //commented out in TB L80
    ...
    public class DownloadJsonData extends DownloadRawData{
        ...
        protected String doInBackground(String... params){
            String[] par = {mDestinationUri.toString()}; //not in TB codeL64
            return super.doInBackground(par);   //TB codeL69 (par) instead of (params)
        }
    }
}
